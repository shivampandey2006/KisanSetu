...
const HowItHelps = () => {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden border-t border-b border-green-200 mx-auto w-[95%] md:w-[80%]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-24 sm:px-10 lg:px-16">
        ...
        <div className="max-w-3xl">
          ...
          <Link
            to="/more-to-know"
            className="group mt-12 inline-flex items-center gap-4 rounded-xl bg-green-600 px-7 py-3.5 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-green-500 hover:shadow-xl"
          >
